var app = new PIXI.Application(100%, 100%, {forceFXAA: true,antialias:true,backgroundColor: colorHex(255,250,240)});//0x1099bb
...
var thanksImage = PIXI.Sprite.from('images/表情1.gif');
